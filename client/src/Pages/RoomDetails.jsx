    ...
    room && (
      <div className="py-28 md-py-35 px-5 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          <h1 className="text-xl md:text-4xl font-Play-fair">
            {room.hotel.name}{" "}
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div className="flex flex-col">
            <h1 className="text-xl md:text-4xl font-Play-fair">
              Expreince Luxury Like Never Before
            </h1>
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <button className="px-6 py-2.5 mt-4 ronded text-white bg-primary hover:bg-primary-dull transition-all cursor-pointer">Contact Now</button>
        </div>
