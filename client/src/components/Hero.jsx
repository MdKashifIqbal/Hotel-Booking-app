...
const Hero = () => {
  return (
    <div   style={{ backgroundImage: `url(${heroImage})` }} className="flex flex-col items-start justify-center px-6 md:px-6 lg:px-32 text-white bg-no-repeat bg-cover bg-center h-screen">
      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20 '>The Ultimate Hotel Experience</p>
      <h1 className='font-Play-fair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Gateway Destination</h1>
